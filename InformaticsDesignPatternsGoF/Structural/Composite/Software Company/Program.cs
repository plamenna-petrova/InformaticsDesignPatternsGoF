...
namespace Software_Company
{
    ...
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            Developer primitiveElement = new Developer("Jerry", 18000, "Junior Frontend Developer");
            companyManager.Add(primitiveElement);
            companyManager.Remove(primitiveElement);
